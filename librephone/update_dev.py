    ...
    def set_columns(
        ...
        for key, value in update_vals.items():
            ...
            if not clean_key.isalnum():
                ...
                return False
            # Securely quote the column name
        ...
        # print(f"SQL: {query.as_string(self.dbshell)}")
        self.dbcursor.execute(query, sql_params)
        return True
